...
class __TwigTemplate_1d7ea8ecfa3f4633a55dd179ecf43dd9392b705aaa2683800860d38e920eb6dc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 69
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 69), "isPopup", [], "method", false, false, false, 69)) {
            // line 70
            echo "          </div>
        </div>
      </div>
